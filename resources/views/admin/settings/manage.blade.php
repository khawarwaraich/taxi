    ...
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form id="settings" method="post" action="" autocomplete="off" enctype="multipart/form-data" abineguid="B59BCE13E9CC4107BFA07C716D61E779">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                <div id="form-group-site_name" class="form-group focused">
                                    ...
                                    <input type="text" name="site_name" id="site_name" class="form-control form-control   " placeholder="Site Name here ..." value="" required="" autofocus="">
                                </div>
                                <div id="form-group-site_description" class="form-group focused">
                                    ...
                                    <input type="text" name="site_description" id="site_description" class="form-control form-control   " placeholder="Site Description here ..." value="" required="" autofocus="">
                                </div>
                                <br>
